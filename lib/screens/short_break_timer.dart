...
class BreakTimerController extends GetxController {
  Timer? _timer;
  ...
  _startTimer() {
    ...
    _timer = Timer.periodic(duration, (Timer timer) {
      if (remainingSeconds == 0) {
        ...
        percentage.value = (remainingSeconds / 300).toString();
        remainingSeconds--;
      }
    });
  }
...
class _ShortBreakTimerScreen extends State<ShortBreakTimerScreen> {
  final controller = Get.put(BreakTimerController());
                              ...
                              child: Center(
                                  child: IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        controller.remainingSeconds = 300;
                                        // controller._startTimer();
                                        controller.time.value = '5:00';
