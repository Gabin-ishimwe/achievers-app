  ...
  _startTimer() {
    ...
    _timer = Timer.periodic(duration, (Timer timer) {
      if (remainingSeconds == 0) {
        ...
        percentage.value = (remainingSeconds / 900).toString();
        remainingSeconds--;
      }
    });
  }
...
class _LongBreakTimerScreen extends State<LongBreakTimerScreen> {
  final controller = Get.put(LongBreakTimerController());
                              ...
                              child: Center(
                                  child: IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        controller.remainingSeconds = 900;
                                        // controller._startTimer();
                                        controller.time.value = '15:00';
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  gradient: LinearGradient(
                                    colors: [
                                      Color(0xFF21C064),
                                      Color.fromRGBO(33, 192, 100, 0.75),
                                    ],
